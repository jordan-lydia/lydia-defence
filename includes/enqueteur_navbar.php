<?php
// Fichier: includes/enqueteur_navbar.php
?>
<header class="navbar-top">
    <!-- Espace vide à gauche pour l'alignement -->
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="images/profile-placeholder.png" alt="Profile" class="rounded-circle">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="enqueteur_profile.php"><i class="fas fa-user-cog"></i><span>Mon Profil</span></a></li>
                    <li><hr class="dropdown-divider"></li>
