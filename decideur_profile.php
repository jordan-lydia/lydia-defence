    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        try {
            ...
            if ($user && $hashed_current_password === $user['mot_de_passe']) {
                ...
                $update_stmt->execute([$hashed_new_password, $decideur_id]);

                log_action($pdo, 'Changement de son propre mot de passe.', 'AUTH', $decideur_id);
...
// Récupérer les informations du décideur pour affichage
try {
...
<head>
    ...
    <title>Mon Profil - Décideur</title>
    ...
    <div class="page-container">
        ...
        <main class="page-content">
            ...
            <div class="page-header mb-4">
                ...
                <p class="page-lead">Gérez vos informations personnelles et la sécurité de votre compte.</p>
            </div>
            
            <div class="row">
                <div class="col-lg-4">
                    <div class="content-block text-center p-4 h-100">
                        <img src="images/Ministre___biogr.webp" alt="Profile" class="img-fluid rounded-circle mb-3" style="width: 120px; height: 120px;">
                        <h4 class="mb-1"><?= htmlspecialchars($user_data['prenom'] . ' ' . $user_data['nom']) ?></h4>
                        <p class="text-muted"><?= htmlspecialchars($user_data['email']) ?></p>
                        <span class="badge text-bg-dark">Décideur</span>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="content-block h-100">
                        ...
                        <form action="decideur_profile.php" method="POST">
                            <div class="mb-3">
