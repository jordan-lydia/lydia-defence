    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        try {
            ...
            if ($user && $hashed_current_password === $user['mot_de_passe']) {
                // 3. Le mot de passe actuel est correct, on peut le changer
                ...
                // Log de l'action
                log_action($pdo, 'Changement de son propre mot de passe.', 'AUTH', $admin_id);
...
// Récupérer les informations de l'admin pour affichage
try {
...
<head>
    ...
    <title>Mon Profil - Admin STDM</title>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="content-block text-center p-4">
                    <img src="images/360_F_644857382_DYcfuCz7SEVBLejwX9YQ0UUNPvD8B9Rs.jpg" alt="Profile" class="img-fluid rounded-circle mb-3" style="width: 120px; height: 120px;">
                    <h4 class="mb-1"><?= htmlspecialchars($admin_data['prenom'] . ' ' . $admin_data['nom']) ?></h4>
                    <p class="text-muted"><?= htmlspecialchars($admin_data['email']) ?></p>
